...
interface CallContextType {
  ...
  livekit: ReturnType<typeof useLiveKitContext>;
  session: ReturnType<typeof useSession>;
  useLiveKitFlag: boolean;
}
...
export const CallProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Feature flag to switch between Mediasoup and LiveKit
  const useLiveKitFlag = process.env.NEXT_PUBLIC_USE_LIVEKIT === 'true';

  return (
    <CallContext.Provider value={{ state, dispatch, mediasoup, livekit, session, useLiveKitFlag }}>
      {children}
